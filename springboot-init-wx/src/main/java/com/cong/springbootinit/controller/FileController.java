...
public class FileController {
    ...
    public BaseResponse<String> uploadFile(@RequestPart("file") MultipartFile multipartFile,
            UploadFileRequest uploadFileRequest, TokenUserRequest tokenUserRequest) {
        ...
        String filepath = String.format("/%s/%s/%s", fileUploadBizEnum.getValue(), tokenUserRequest.getId(), filename);
        File file = null;
        try {
            // 上传文件
